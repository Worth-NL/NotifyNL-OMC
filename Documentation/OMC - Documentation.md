...
| KTO_CASETYPESETTINGS                                 | string    | "A Json list of settings"                     | false        | Cannot be missing and have null or empty value. When not implemented fill with "-".                                                        | Defines the mapping of case types to KTO service configuration: "{"ApproveAutomatically": true,"IsTest": true,"caseTypeSettings":[{"caseTypeId":"whitelisted","Vragenlijst_naam":"Brede intake","Dienst_naam":"SCW","Type_meting":"Product KTO"},{"caseTypeId":"whitelisted 2","Vragenlijst_naam":"Brede intake","Dienst_naam":"SCW","Type_meting":"Product KTO"}]}" |
| ---                                                  | ---       | ---                                           | ---          | ---                                                                                                                                        | ---                                                                                                                                                                                                          |
...
| ---                                                  | ---       | ---                                           | ---          | ---                                                                                                                                        | ---                                                                                                                                                                                                          |
| ZGW_ENDPOINT_OPENNOTIFICATIES                        | string    | "https://opennotificaties.mycity.nl/api/v1"   | false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OPENZAAK                                | string    | "https://openzaak.mycity.nl/zaken/api/v1"     | false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OPENKLANT                               | string    | "https://openklant.mycity.nl/klanten/api/v1"  | false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_BESLUITEN                               | string    | "https://besluiten.mycity.nl/besluiten/api..."| false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OBJECTEN                                | string    | "https://objecten.mycity.nl/api/v2"           | false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OBJECTTYPEN                             | string    | "https://objecttypen.mycity.nl/api/v2"        | false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_CONTACTMOMENTEN                         | string    | "https://openklant.mycity.nl/contactmoment..."| false        | Cannot be missing and have null or empty value. Without slash at the end                                                                   | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ---                                                  | ---       | ---                                           | ---          | ---                                                                                                                                        | ---                                                                                                                                                                                                          |
...
| ZGW_ENDPOINT_OPENZAAK                                | string    | "https://openzaak.mycity.nl/zaken/api/v1"    | false        | Cannot be missing and have null or empty value. Without slash at the end                                                               | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OPENKLANT                               | string    | "https://openklant.mycity.nl/klanten/api/v1" | false        | Cannot be missing and have null or empty value. Without slash at the end                                                               | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_BESLUITEN                               | string    | "https://besluiten.mycity.nl/besluiten/ap..."| false        | Cannot be missing and have null or empty value. Without slash at the end                                                               | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OBJECTEN                                | string    | "https://objecten.mycity.nl/api/v2"          | false        | Cannot be missing and have null or empty value. Without slash at the end                                                               | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_OBJECTTYPEN                             | string    | "https://objecttypen.mycity.nl/api/v2"       | false        | Cannot be missing and have null or empty value. Without slash at the end                                                               | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ZGW_ENDPOINT_CONTACTMOMENTEN                         | string    | "https://openklant.mycity.nl/contactmomen..."| false        | Cannot be missing and have null or empty value. Without slash at the end                                                               | You have to use the domain part from URLs where you are hosting the dedicated Open services                                                                                                                  |
| ---                                                  | ---       | ---                                          | ---          | ---                                                                                                                                    | ---                                                                                                                                                                                                          |
| ZGW_WHITELIST_ZAAKCREATE_IDS                         | string[]  | "1, 2, 3, 4" or "\*" (allow everything)      | false        |                                                                                                                                        | Is provided by the user based on "Identificatie" property of case type retrieved from case URI ("zaak") from "OpenZaak" Web API service                                                                      |
| ZGW_WHITELIST_ZAAKUPDATE_IDS                         | string[]  | "1, 2, 3, 4" or "\*" (allow everything)      | false        |                                                                                                                                        | Is provided by the user based on "Identificatie" property of case type retrieved from case URI ("zaak") from "OpenZaak" Web API service                                                                      |
| ZGW_WHITELIST_ZAAKCLOSE_IDS                          | string[]  | "1, 2, 3, 4" or "\*" (allow everything)      | false        |                                                                                                                                        | Is provided by the user based on "Identificatie" property of case type retrieved from case URI ("zaak") from "OpenZaak" Web API service                                                                      |
...
<h2 id="kto_info">7.1. KTO Implementation</h2>
