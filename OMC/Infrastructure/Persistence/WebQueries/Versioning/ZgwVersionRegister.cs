...
namespace WebQueries.Versioning
{
    ...
    public sealed class ZgwVersionRegister : IVersionRegister
    {
        private readonly IServiceProvider _serviceProvider;

        /// <summary>
        /// Initializes a new instance of the <see cref="ZgwVersionRegister"/> class.
        /// </summary>
        public ZgwVersionRegister(IServiceProvider serviceProvider)  // Dependency Injection (DI)
        {
