...
namespace EventsHandler.Services.DataProcessing.Strategy.Implementations.MessageBox
{
    /// <summary>
    /// 
    /// </summary>
    internal sealed class MessageBoxScenario : BaseScenario
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="KtoScenario"/> class.
        /// </summary>
        public MessageBoxScenario(OmcConfiguration configuration,
