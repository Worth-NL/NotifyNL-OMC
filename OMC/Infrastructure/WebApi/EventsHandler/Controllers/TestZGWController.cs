...
namespace EventsHandler.Controllers
{
    ...
    public sealed class TestZGWController : OmcController // Swagger UI requires this class to be public
    {
        private readonly IQueryContext _queryContext;
        private readonly IRespondingService<ProcessingResult> _responder;

        /// <summary>
        /// Initializes a new instance of the <see cref="TestZGWController"/> class.
        /// </summary>
        /// <param name="queryContext">The adapter containing external Web API queries.</param>
        /// <param name="responder">The output standardization service (UX/UI).</param>
        public TestZGWController(
        ...
        #region ZGW Test endpoints
        private const string Test = nameof(Test);
        private const string ZGW = nameof(ZGW);
        private const string UrlStart = $"/{Test}/{ZGW}/";
