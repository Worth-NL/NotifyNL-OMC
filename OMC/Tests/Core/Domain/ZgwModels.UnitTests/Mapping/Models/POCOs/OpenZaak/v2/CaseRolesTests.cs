...
namespace ZgwModels.Tests.Unit.Mapping.Models.POCOs.OpenZaak.v2
{
    [TestFixture]
    public sealed class CaseRolesTests
    {
        ...
        public void Citizen_Method_ForMissingResults_ThrowsHttpRequestException()
        {
            ...
            // Act & Assert
            AssertThrows<HttpRequestException>(testConfiguration, caseRoles, ZgwResources.HttpRequest_ERROR_EmptyCaseRoles);
        }
        ...
        public void Citizen_Method_ForExistingResults_WithoutInitiatorRole_ThrowsHttpRequestException()
        {
            ...
            // Act & Assert
            AssertThrows<HttpRequestException>(this._testConfiguration, caseRoles, ZgwResources.HttpRequest_ERROR_MissingInitiatorRole);
        }
