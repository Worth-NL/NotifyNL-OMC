    ...
    public sealed class SpecificSerializerTests
    {
        ...
        public void Deserialize_IJsonSerializable_From_EmptyJson_ThrowsJsonException_ListsRequiredProperties()  // NOTE: Simple model
        {
            ...
            IEnumerable<(int Id, Action Deserialization, string TargetName, string Failed, string ExpectedResult)> GetSerializationTests(string testJson)
            {
                ...
                yield return (2, () => this._serializer.Deserialize<PartyResult>(testJson), nameof(PartyResult), "'url', 'voorkeursDigitaalAdres', '_expand'.", "'url', 'voorkeursDigitaalAdres', '_expand.digitaleAdressen.uuid', '_expand.digitaleAdressen.adres', '_expand.digitaleAdressen.soortDigitaalAdres', '_expand.digitaleAdressen.referentie'");
        ...
        public void Serialize_Case_Default_ReturnsExpectedJson(bool isDefault)
        {
            ...
            // Expected JSON includes new required properties: laatstGemuteerd, laatstGeopend and status
