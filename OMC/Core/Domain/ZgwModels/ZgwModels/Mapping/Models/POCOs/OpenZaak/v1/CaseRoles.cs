...
namespace ZgwModels.Mapping.Models.POCOs.OpenZaak.v1
{
    /// <summary>
    ...
    public struct CaseRoles : IJsonSerializable
    {
        ...
        public readonly CaseRole CaseRole(OmcConfiguration configuration)
        {
            ...
            {
                throw new HttpRequestException(ZgwResources.HttpRequest_ERROR_EmptyCaseRoles);
            }
            ...
            throw new HttpRequestException(ZgwResources.HttpRequest_ERROR_MissingInitiatorRole);
        }
    }
}